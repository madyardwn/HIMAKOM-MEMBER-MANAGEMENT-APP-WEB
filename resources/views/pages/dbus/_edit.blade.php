<div class="modal fade" id="modal-edit-dbus" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-edit-dbus">
                    <input type="hidden" name="id" id="edit-id-dbus">
                    <div class="row">
                        <div class="col-md-5">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary ms-auto" id="submit-edit-dbus">
